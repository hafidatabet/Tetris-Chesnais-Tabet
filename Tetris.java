...
public class Tetris extends Applet {
 ...
 private static final long serialVersionUID = 7526471155622776147L;
	...
	private final static Color BACKGROUND_COLOR = new Color(0xCC66FF);
	...
	private void startGame() {
		...
		start_newgame_butt.setLabel("Nouvelle Partie");
	...
	private void pauseGame() {
		timer.setPaused(true);
		pause_resume_butt.setLabel("Reprendre");
	...
	public void init() {
		 // NOTE: Must be initialized after Applet fully constructed!
		installNewPiece();
	...
	public static void main(String[] args) {
		...
		Frame frame = new Frame("\tTetris $Chesnais-Tabet$\t");
